...
public class tradingAPI {
	...
	public String SendPayment(String sourceAccount,String destAccount, float amount)throws ExecutionException, InterruptedException{
        ...
        if (sourceBalance>=amount) {
        	...
        	PutResponse putresponse = getKVClient().put(bytesOf(sourceAccount), bytesOf(value)).get();
        	...
        	PutResponse putresponse2 = getKVClient().put(bytesOf(destAccount), bytesOf(newValue)).get();
